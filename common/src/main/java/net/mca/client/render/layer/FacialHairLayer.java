...
public class FacialHairLayer<T extends LivingEntity, M extends BipedEntityModel<T>> extends VillagerLayer<T, M> {
    public FacialHairLayer(FeatureRendererContext<T, M> renderer, M model) {
